	...
	public class CategoryController : Controller
	{
		...
		public async Task<IActionResult> Add(CategoryAddDto categoryAddDto)
		{
			...
			if (result.IsValid)
			{
				...
				toast.AddSuccessToastMessage(Messages.Category.Add(categoryAddDto.Name), new ToastrOptions { Title = "" });
		...
		public async Task<IActionResult> Update(CategoryUpdateDto categoryUpdateDto)
		{
			...
			if (result.IsValid)
			{
				...
				toast.AddSuccessToastMessage(Messages.Category.Update(name), new ToastrOptions { Title = "" });
				return RedirectToAction("Index", "Category", new { area = "Admin" });
		...
		public async Task<IActionResult> Delete(Guid categoryId)
		{
			...
			toast.AddSuccessToastMessage(Messages.Category.Delete(title), new ToastrOptions { Title = "" });

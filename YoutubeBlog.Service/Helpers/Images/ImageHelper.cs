...
namespace YoutubeBlog.Service.Helpers.Images
{
	public class ImageHelper : IImageHelper
	{
		...
		{
			// "??=" bir değişkenin değeri null ise sağ tarafındaki ifadeyi atar ve değişkenin değerini günceller.
			...
			string message = imageType == ImageType.User ?
				$"{newFileName} User picture added successfully."
				: $"{newFileName} Article picture added successfully";
